...
//                .filter(u -> isMatch(searchQuery, u.getEmailAddress().toLowerCase()))
...
//        Collection<Connection> connectionsFollowing = new ArrayList<>();
...
//        }
//
//        Collection<Connection> connectionsFollowedBy = new ArrayList<>();
...
////        }
//
//        connectionsFollowing = new ArrayList<>();
////        for (Connection con : connectionsFollowing) {
////            if (!con.getIsAccepted() && con.getUser() == otherUser) {
////                return true;
////            }
